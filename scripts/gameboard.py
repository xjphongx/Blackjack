    ...
    def render(self,display):
        ...
        if self.hand_1_button.draw(self.game.display):
            if self.hand_1_button.isActive == False:
                self.game.player.add_Hand(1) #add hand at position 1
        ...
        #TODO add betting bar and functinality
